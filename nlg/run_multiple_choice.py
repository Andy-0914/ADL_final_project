...
def main():
    ...
    def preprocess_function(examples):
        first_sentences = [[context] * 3 for context in examples[context_name]]
        second_sentences = [
            [chitchat + ' ' + response, response, response + ' ' + chitchat] for chitchat, response in zip(examples[chitchat_name], examples[response_name]) 
        ]
